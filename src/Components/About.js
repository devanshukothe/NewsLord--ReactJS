  ...
  return (
    <>
      ...
      <div class="container px-4 py-5" id="icon-grid">
        <h1 class="pb-2 border-bottom text-center text-bold">News Category</h1>

        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 g-3 py-5">
          <div class="col d-flex align-items-start">
            <div>
              <h4 class="fw-bold mb-0">Business Headlines</h4>
              <p>
          ...
          <div class="col d-flex align-items-start">
            <div>
              <h4 class="fw-bold mb-0">Entertainment Headlines</h4>
              <p>
          ...
          <div class="col d-flex align-items-start">
            <div>
              <h4 class="fw-bold mb-0">Health Headlines</h4>
              <p>
          ...
          <div class="col d-flex align-items-start">
            <div>
              <h4 class="fw-bold mb-0">Science Headlines</h4>
              <p>
          ...
          <div class="col d-flex align-items-start">
            <div>
              <h4 class="fw-bold mb-0">Sports Headlines</h4>
              <p>
          ...
          <div class="col d-flex align-items-start">
            <div>
              <h4 class="fw-bold mb-0">Technology Headlines</h4>
              <p>
